                ...
                <ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-book"></i> Cadastro <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="/fornecedor/novo">Fornecedor</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-money"></i> Vendas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form_advanced.html">Canceladas</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-tasks"></i> Estoque <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
